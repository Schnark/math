	...
	return {
		toString: function () {
			return [
				...
				'To get help on a function, just use the "help" function with the name of the function you want to learn about. You can also read the online help on https://mathjs.org/docs/index.html (since that library is used internally).',
